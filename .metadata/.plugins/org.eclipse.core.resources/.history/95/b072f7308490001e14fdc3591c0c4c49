...
public class GustaveTutorServiceServiceLocator extends org.apache.axis.client.Service implements service.GustaveTutorServiceService {
    ...
    private java.lang.String GustaveTutorService_address = "http://localhost:8080/TutoringPlatform/services/GustaveTutorService";
    ...
    public service.GustaveTutorService getGustaveTutorService() throws javax.xml.rpc.ServiceException {
    ...
    public service.GustaveTutorService getGustaveTutorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.GustaveTutorServiceSoapBindingStub _stub = new service.GustaveTutorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.GustaveTutorService.class.isAssignableFrom(serviceEndpointInterface)) {
                service.GustaveTutorServiceSoapBindingStub _stub = new service.GustaveTutorServiceSoapBindingStub(new java.net.URL(GustaveTutorService_address), this);
                _stub.setPortName(getGustaveTutorServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service", "GustaveTutorServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service", "GustaveTutorService"));
        }
